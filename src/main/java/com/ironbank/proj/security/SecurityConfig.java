package com.ironbank.proj.security;

import com.ironbank.proj.filters.CustomAuthenticationFilter;
import com.ironbank.proj.filters.CustomAuthorizationFilter;
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                .requestMatchers("/api/login/**").permitAll()
                    ...
                    .requestMatchers(GET,"/api/account_holder/**").hasAnyAuthority("ROLE_ACCOUNT_HOLDER", "ROLE_ADMIN")
